 ...
 */
public class UserMainActivity extends ActivityBase implements EventListener{
...
//		BmobChat.getInstance(this).startPollService(30);
	...
	private void refreshNewMsg(BmobMsg message){
		...
		//也要存储起来
		if(message!=null){
			BmobChatManager.getInstance(UserMainActivity.this).saveReceiveMessage(true,message);
		}
